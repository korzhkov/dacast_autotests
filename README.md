...
<ul>
<li><a href="https://docs.dacast.com/reference/create-stream" target="_blank">Create stream</a> via API with live_recording_enabled and live_dvr_enabled set to true</li>
